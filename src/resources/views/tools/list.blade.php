                ...
                <div class="overflow-hidden card" data-aos="fade-up" data-aos-delay="600">
                    <div class="flex-wrap card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="mb-2 card-title">Tools</h4>
                        </div>
                        <div>
                            <a href="{{route('tool.create.get')}}" class="btn btn-primary">Add Tool</a>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="{{route('tool.view.get', $item->id)}}">{{$item->name}}</a>
                                            </div>
                                        </td>

                                        <td>
                                            @can('view tools')
                                            <a href="{{route('tool.view.get', $item->id)}}" class="" data-bs-toggle="tooltip" data-bs-original-title="View Tool"> <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            @can('edit tools')
                                            <a href="{{route('tool.update.get', $item->id)}}" class="" data-bs-toggle="tooltip" data-bs-original-title="Edit Tool"> <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            @can('delete tools')
                                            <a href="#" class="remove-item-btn" data-link="{{route('tool.delete.get', $item->id)}}" data-bs-toggle="tooltip" data-bs-original-title="Delete Tool"> <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
