																																																												...
																																																												<td>
																																																																...
																																																																@can("view events")
																																																																				<a href="{{ route("event.view.get", $item->id) }}"
																																																																								...
																																																																								data-bs-original-title="View Event"> <svg
																																																																...
																																																																@can("edit events")
																																																																				<a href="{{ route("event.update.get", $item->id) }}"
																																																																								class="" data-bs-toggle="tooltip"
																																																																								data-bs-original-title="Edit Event"> <svg
																																																																												width="32" viewBox="0 0 24 24" fill="none"
																																																																												xmlns="http://www.w3.org/2000/svg">
																																																																												<path opacity="0.4"
																																																				...
																																																				<tr>
																																																								...
																																																								<td>
																																																												...
																																																												@can("view events")
																																																																<a href="{{ route("event.view.get", $item->id) }}"
																																																																				class="" data-bs-toggle="tooltip"
																																																																				data-bs-original-title="View Event"> <svg width="32"
																																																																								viewBox="0 0 24 24" fill="none"
																																																																								xmlns="http://www.w3.org/2000/svg">
																																																																								<path opacity="0.4" fill-rule="evenodd"
																																																																												clip-rule="evenodd"
																												...
																												@foreach ($document_notification as $k => $itm)
																																@if (!empty($itm->event_document_id))
																																				<div class="d-flex profile-media align-items-top mb-2">
																																								...
																																								<div class="ms-4">
																																												<h6 class="mb-1"><a href="{{ $itm->document->document_link }}" download
																																																				data-bs-toggle="tooltip"
																																																				data-bs-original-title="{{ str()->snake($itm->document->event->name) . "_EVD" . $itm->document->event->id . "." . \File::extension(str_replace("storage/documents/", "", $itm->document->document)) }}">{{ str()->limit(str()->snake($itm->document->event->name) . "_EVD" . $itm->document->event->id . "." . \File::extension(str_replace("storage/documents/", "", $itm->document->document)), 35) }}</a>
																																												</h6>
																																...
																																@elseif(!empty($itm->created_event_id))
																																				<div class="d-flex profile-media align-items-top mb-2">
																																								<div class="profile-dots-pills border-primary mt-1"></div>
																																								<div class="ms-4">
																																												<h6 class="mb-1"><a href="{{ $itm->created_event->event_link }}"
																																																				data-bs-toggle="tooltip"
																																																				data-bs-original-title="{{ $itm->created_event->name }}">{{ str()->limit($itm->created_event->name, 35) }}</a>
																																												</h6>
																																												<span class="mb-0">{{ $itm->created_at->format("M d Y h:i a") }}</span>
																																								</div>
																																				</div>
																																@elseif(!empty($itm->updated_event_id))
																																				<div class="d-flex profile-media align-items-top mb-2">
																																								<div class="profile-dots-pills border-primary mt-1"></div>
																																								<div class="ms-4">
																																												<h6 class="mb-1"><a href="{{ $itm->updated_event->event_link }}"
																																																				data-bs-toggle="tooltip"
																																																				data-bs-original-title="{{ $itm->updated_event->name }}">{{ str()->limit($itm->updated_event->name, 35) }}</a>
																																												</h6>
																																												<span class="mb-0">{{ $itm->created_at->format("M d Y h:i a") }}</span>
																																								</div>
																																				</div>
