																																																				...
																																																				<div
																																																								...
																																																								@foreach ($data as $k => $v)
																																																												<table width="100%" border="0"
																																																																...
																																																																@if ($v->event->is_recurring_event)
																																																																				@foreach ($v->event->event_repeated_date as $r_date)
																																																																								...
																																																																								@endif
																																																																				@endforeach
                                                                                                                                                                                                                                                                                @if(count($v->event->event_repeated_date)>0)
                                                                                                                                                                                                                                                                                <tr style="width: 100%">
																																																																								<td style="width: 25%">Event end date:</td>
																																																																								<td>{{ $v->event->recurring_end_date->format("M d Y") }}
																																																																								</td>
																																																																				</tr>
                                                                                                                                                                                                                                                                                @endif
																																																																@else
																																																																				<tr style="width: 100%">
																																																																								<td style="width: 25%">Event start date:</td>
																																																																								<td>{{ $v->event->start_date->format("M d Y") }}
																																																																								</td>
																																																																				</tr>
																																																																				<tr style="width: 100%">
																																																																								<td style="width: 25%">Event end date:</td>
																																																																								<td>{{ $v->event->end_date->format("M d Y") }}
																																																																								</td>
																																																																				</tr>
																																																																@endif
																																																																...
																																																																<tr style="width: 100%">
																																																																				...
																																																																				<td>{{ $v->event->start_time->timezone(auth()->user()->timezone ? strtok(auth()->user()->timezone->value, " GMT") : "UTC")->format("h:i a") }}
																																																																				</td>
																																																																</tr>
																																																																<tr style="width: 100%">
