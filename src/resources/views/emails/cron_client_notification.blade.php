																				...
																				<td style="word-break: break-word; vertical-align: top;" valign="top">
																																																								...
																																																								@foreach ($data as $k => $v)
                                                                                                                                                                                                                                    @if ($v->is_recurring_event)
                                                                                                                                                                                                                                        @foreach ($v->event_repeated_date as $r_date)
                                                                                                                                                                                                                                            @if(
                                                                                                                                                                                                                                            ($notification_type=='Daily' && $carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(1)->format("m/d/Y").' 00:00:00')->eq($carbon::createFromFormat('m/d/Y H:i:s', $carbon::parse($r_date)->format("m/d/Y").' 00:00:00'))) ||
                                                                                                                                                                                                                                            ($notification_type=='Weekly' && $carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(1)->format("m/d/Y").' 00:00:00')->lte($carbon::createFromFormat('m/d/Y H:i:s', $carbon::parse($r_date)->format("m/d/Y").' 00:00:00'))  && $carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(7)->format("m/d/Y").' 00:00:00')->gte($carbon::createFromFormat('m/d/Y H:i:s', $carbon::parse($r_date)->format("m/d/Y").' 00:00:00'))) ||
                                                                                                                                                                                                                                            ($notification_type=='Monthly' && $carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(1)->format("m/d/Y").' 00:00:00')->lte($carbon::createFromFormat('m/d/Y H:i:s', $carbon::parse($r_date)->format("m/d/Y").' 00:00:00'))  && $carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(30)->format("m/d/Y").' 00:00:00')->gte($carbon::createFromFormat('m/d/Y H:i:s', $carbon::parse($r_date)->format("m/d/Y").' 00:00:00')))
                                                                                                                                                                                                                                            )
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    @else
                                                                                                                                                                                                                                        @if(
                                                                                                                                                                                                                                            ($carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(1)->format("m/d/Y").' 00:00:00')->gte($carbon::createFromFormat('m/d/Y H:i:s', $v->start_date->format("m/d/Y").' 00:00:00')))
                                                                                                                                                                                                                                            && ($carbon::createFromFormat('m/d/Y H:i:s', $carbon::today()->addDay(1)->format("m/d/Y").' 00:00:00')->lte($carbon::createFromFormat('m/d/Y H:i:s', $v->end_date->format("m/d/Y").' 00:00:00')))
                                                                                                                                                                                                                                            )
                                                                                                                                                                                                                                            <table width="100%" border="0"
                                                                                                                                                                                                                                                            style="text-align:left">
                                                                                                                                                                                                                                                            <tr style="width: 100%">
																								...
																								<div style="background-color:transparent;">
																												<div class="block-grid two-up no-stack"
																																...
																																<div
																																				style="border-collapse: collapse;display: table;width: 100%;background-color:#354620;">
