																																																								...
																																																								@foreach ($data as $k => $v)
																																																												<table width="100%" border="0"
																																																																...
																																																																<tr style="width: 100%">
																																																																				...
																																																																				<td>{{ $v->start_time->timezone(auth()->user()->timezone ? strtok(auth()->user()->timezone->value, " GMT") : "UTC")->format("h:i a") }}
																																																																				</td>
																																																																</tr>
																																																																<tr style="width: 100%">
																																																																				<td style="width: 25%">Event End Time:</td>
																																																																				<td>{{ $v->end_time->timezone(auth()->user()->timezone ? strtok(auth()->user()->timezone->value, " GMT") : "UTC")->format("h:i a") }}
																																																																				</td>
																																																																</tr>
																																																																<tr style="width: 100%">
