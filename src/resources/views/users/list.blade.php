																				...
																				<div class="card overflow-hidden" data-aos="fade-up" data-aos-delay="600">
																								<div class="card-header d-flex justify-content-between flex-wrap">
																												<div class="header-title d-flex align-items-center gap-2">
																																...
																																<form method="GET" action="{{ route("user.paginate.get") }}" id='sort-form'
																																				class="col-auto">
																																				<select class="form-select shadow-none" id="sort" name="filter[role]">
																																								<option value="all"
																																												{{ empty(request()->query("filter")["role"]) ? "selected" : "" }}>Filter By
																																								</option>
																																								<option value="all"
																																												{{ !empty(request()->query("filter")["role"]) && request()->query("filter")["role"] == "all" ? "selected" : "" }}>
																																												All</option>
																																								<option value="Admin"
																																												{{ !empty(request()->query("filter")["role"]) && request()->query("filter")["role"] == "Admin" ? "selected" : "" }}>
																																												Admin</option>
																																								<option value="Writer"
																																												{{ !empty(request()->query("filter")["role"]) && request()->query("filter")["role"] == "Writer" ? "selected" : "" }}>
																																												Writer</option>
																																								<option value="Client"
																																												{{ !empty(request()->query("filter")["role"]) && request()->query("filter")["role"] == "Client" ? "selected" : "" }}>
																																												Client</option>
																																				</select>
																																</form>
																												</div>
																																																...
																																																<tr>
																																																				<td>
																																																								<div class="d-flex align-items-center">
																																																												<a
																																																																href="{{ route("user.view.get", $item->id) }}">{{ $item->name }}</a>
																																																								</div>
																																																				</td>
																																																				<td>
																																																								<div class="d-flex align-items-center">
																																																												<a
																																																																href="{{ route("user.view.get", $item->id) }}">{{ $item->email }}</a>
																																																								</div>
																																																				</td>
																																																				<td>
																																																				...
																																																				<td>
																																																								@can("edit users")
																																																												@if (!$item->is_blocked)
																																																																<a href="#" class="remove-item-btn"
																																																																				data-link="{{ route("user.status.get", $item->id) }}"
																																																																				data-bs-toggle="tooltip" data-bs-original-title="Active">
																																																												...
																																																												@else
																																																																<a href="#" class="remove-item-btn"
																																																																				data-link="{{ route("user.status.get", $item->id) }}"
																																																																				data-bs-toggle="tooltip" data-bs-original-title="Blocked">
																																																								...
																																																								@can("view users")
																																																												<a href="{{ route("user.view.get", $item->id) }}" class=""
																																																								...
																																																								@can("edit users")
																																																												<a href="{{ route("user.update.get", $item->id) }}" class=""
																																																								...
																																																								@can("delete users")
																																																												<a href="#" class="remove-item-btn"
																																																																data-link="{{ route("user.delete.get", $item->id) }}"
