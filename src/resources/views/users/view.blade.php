																...
																<div class="card">
																				...
																				<div class="card-body">
																								...
																								<div class="form-group row">
																												...
																												<div class="col-sm-10">
																																{{ $user->current_role == "Staff-Admin" || $user->current_role == "Super Admin" || $user->current_role == "Super-Admin" ? "Admin" : $user->current_role }}
																												</div>
																								</div>
																								<div class="form-group row">
																								...
																								@if ($user->current_role == "Client")
																												<div class="form-group row">
																																<label class="control-label col-sm-2 align-self-center mb-0" for="eventName">Client
																																				:</label>
																																<div class="col-sm-10">
																								...
																								@endif
																								<div class="form-group row">
																												<label class="control-label col-sm-2 align-self-center mb-0" for="eventName">Registration Date
																																:</label>
																												<div class="col-sm-10">
																												...
																												<div class="col-sm-10">
																																@if (!$user->is_blocked)
																																				<a href="javascript:void(0)" class="" data-bs-toggle="tooltip"
																																								data-bs-original-title="Active"> <svg width="32" viewBox="0 0 24 24"
																																...
																																@else
																																				<a href="javascript:void(0)" class="" data-bs-toggle="tooltip"
																																								...
																																								<svg fill="red" width="10px" height="10px" version="1.1" id="Capa_1"
																								...
																								<div class="form-group row">
																												<label class="control-label col-sm-2 align-self-center mb-0" for="client">Profile
																																Picture:</label>
																												<div class="col-sm-10">
