<nav class="nav navbar navbar-expand-lg navbar-light iq-navbar">
    <div class="container-fluid navbar-inner">
        ...
        <form action="{{route('event.paginate.get')}}" method="GET" class="input-group search-input">
            ...
            <input type="search" class="form-control" name="filter[search]" placeholder="Search Event..." value="{{request()->query('filter')['search'] ?? ''}}">
        </form>
