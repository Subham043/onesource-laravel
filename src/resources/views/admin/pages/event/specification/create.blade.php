...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list events')
        @include('admin.includes.breadcrumb', ['page'=>'Product Specification', 'page_link'=>route('event.specification.paginate.get', $event_id), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('event.specification.create.post', $event_id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('event.specification.create.post', $event_id)}}', formData)
