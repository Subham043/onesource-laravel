...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list achievers')
        @include('admin.includes.breadcrumb', ['page'=>'Category', 'page_link'=>route('achiever.category.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('achiever.category.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('achiever.category.create.post')}}', formData)
