...
<div class="page-content">
    <div class="container-fluid">
        ...
        @include('admin.includes.breadcrumb', ['page'=>'Expert Tip', 'page_link'=>route('expert_tip.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->

        <div class="row" id="image-container">
            @include('admin.includes.back_button', ['link'=>route('expert_tip.paginate.get')])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('expert_tip.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Expert Tip Detail</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                                        ...
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    ...
                                                    <label class="form-check-label" for="is_active">Expert Tip Publish</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    ...
                                                    <label class="form-check-label" for="is_popular">Is Expert Tip Popular?</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    ...
                                                    <label class="form-check-label" for="is_updated">Is Expert Tip Updated?</label>
                                                </div>
                                            </div>
                    ...
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Expert Tip Seo Detail</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('expert_tip.update.post', $data->id)}}', formData)
