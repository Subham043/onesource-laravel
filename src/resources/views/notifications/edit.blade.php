                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-12 {{ !empty($notification->recurring_type) && $notification->recurring_type->value == "Daily" ? "d-block" : "d-none" }}"
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-12 {{ !empty($notification->recurring_type) && $notification->recurring_type->value == "Weekly" ? "d-block" : "d-none" }}"
                            ...
                            <div class="form-group row noborder align-items-center">
                                ...
                                <div class="col-lg-10 col-md-9 col-sm-12 {{ !empty($notification->recurring_type) && $notification->recurring_type->value == "Monthly" ? "d-block" : "d-none" }}"
