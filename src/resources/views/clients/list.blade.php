                            ...
                            <table id="basic-table" class="table mb-0 table-striped" role="grid">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('view clients')
                                            <a href="{{route('client.view.get', $item->id)}}" class="" data-bs-toggle="tooltip" data-bs-original-title="View Client"> <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            @can('edit clients')
                                            <a href="{{route('client.update.get', $item->id)}}" class="" data-bs-toggle="tooltip" data-bs-original-title="Edit Client"> <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            @can('delete clients')
                                            <a href="#" class="remove-item-btn" data-link="{{route('client.delete.get', $item->id)}}" data-bs-toggle="tooltip" data-bs-original-title="Delete Client"> <svg width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
